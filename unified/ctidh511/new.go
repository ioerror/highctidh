...
var _ interfaces.CTIDH = (*CTIDH511)(nil)
var _ interfaces.PrivateKey = (*PrivateKey)(nil)
var _ interfaces.PublicKey = (*PublicKey)(nil)

type CTIDH511 struct{}

func (c *CTIDH511) Name() string {
	return "CTIDH511"
}

func (c *CTIDH511) Blind(blindingFactor interfaces.PrivateKey, pubKey interfaces.PublicKey) interfaces.PublicKey {
...
func (c *CTIDH511) DH(privKey interfaces.PrivateKey, pubKey interfaces.PublicKey) interfaces.PublicKey {
	return &PublicKey{
		pubKey: ctidh.GroupAction(privKey.(*PrivateKey).privKey, pubKey.(*PublicKey).pubKey),
	}
}

func (c *CTIDH511) DerivePublicKey(privKey interfaces.PrivateKey) interfaces.PublicKey {
	return &PublicKey{
		pubKey: ctidh.DerivePublicKey(privKey.(*PrivateKey).privKey),
	}
}

func (c *CTIDH511) GenerateSecretKey(rng io.Reader) interfaces.PrivateKey {
	return &PrivateKey{
		privKey: ctidh.GeneratePrivateKey(rng),
	}
}

func (c *CTIDH511) Validate(pubkey interfaces.PublicKey) bool {
...
func (c *CTIDH511) PrivateKeyFromBytes(b []byte) interfaces.PrivateKey {
...
func (c *CTIDH511) PrivateKeyFromHex(h string) interfaces.PrivateKey {
...
func (c *CTIDH511) PublicKeyFromBytes(b []byte) interfaces.PublicKey {
...
func (c *CTIDH511) PublicKeyFromHex(h string) interfaces.PublicKey {
	v, err := hex.DecodeString(h)
	if err != nil {
		panic(err)
	}
