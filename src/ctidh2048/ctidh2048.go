...
func (p *PrivateKey) Bytes() []byte {
	return C.GoBytes(unsafe.Pointer(&p.privateKey), C.sizeof_highctidh_2048_private_key)
}
...
func DerivePublicKey(privKey *PrivateKey) *PublicKey {
	var base C.highctidh_2048_public_key = C.highctidh_2048_base
...
func init() {
	...
	PublicKeySize = 256
	PrivateKeySize = C.sizeof_highctidh_2048_private_key
}
